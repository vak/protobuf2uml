...
//     -> ^(package_def* import_def* option_line_def* enum_def* ext_def* message_def* service_def*)
  ;
// Proto ------------------------------
...
// Import -----------------------------
import_def
  :  IMPORT_LITERAL IMPORT_PUBLIC? import_file_name ITEM_TERMINATOR
//     -> ^(IMPORT_LITERAL IMPORT_PUBLIC* import_file_name)
  ;
...
option_field_def
  :  BRACKET_OPEN //! 
                option_field_item (COMMA //! 
                              option_field_item)* BRACKET_CLOSE //!
  ;
